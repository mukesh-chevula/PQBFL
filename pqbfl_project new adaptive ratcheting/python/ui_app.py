...
def _run_security_checks() -> list[dict]:
    ...
    try:
        ...
        key = os.urandom(32)
        nonce = os.urandom(12)
        ct = aead_encrypt(key, b"secret", aad=b"aad", nonce=nonce)
    ...
    try:
        ...
        ss1 = ecdh_shared_secret_x25519(a.private_key, b.public_key_bytes)
        ss2 = ecdh_shared_secret_x25519(b.private_key, a.public_key_bytes)
        assert ss1 == ss2
    ...
    try:
        ...
        kp = ed25519_keygen()
        sig = ed25519_sign(kp.private_key, b"msg")
